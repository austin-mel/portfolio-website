...
const exploratoryFigures = [
  ...
  },
  {
    ...
    body: 'Systematic tail departures show that a log-normal assumption is useful as a reference but too rigid as the final model.',
