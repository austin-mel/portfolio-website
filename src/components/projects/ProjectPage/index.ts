export { default as BackToProjectsButton } from './BackToProjectsButton.vue';
export { default as BaselineNoiseProjectPage } from './BaselineNoiseProjectPage.vue';
export { default as PharmatrialProjectPage } from './PharmatrialProjectPage.vue';
export { default as ProjectPdfReportModal } from './ProjectPdfReportModal.vue';
...
export { default as SirsSurvivalAnalysisProjectPage } from './SirsSurvivalAnalysisProjectPage.vue';
